...
void mazeo(bool Maze[][MAX], int N, bool marks[][MAX], bool &found, int &steps, int &realsteps, Cell &pos, Cell dest);
...
int main(){
	...
	mazeo(Maze, N, marks, found, steps, realsteps, pos, dest);
